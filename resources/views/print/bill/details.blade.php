            ...
            <div class="col-xs-12">
                <table id="sortingTable" class="table table-bordered table-condensed">
                    ...
                    <tr>
                        ...
                        <th class="p-5 pt-0 pb-0 ">Types</th>
                        <th class="p-5 pt-0 pb-0 ">Package</th>
                        <th class="p-5 pt-0 pb-0 ">Card</th>
                    ...
                    @foreach($table as $row)
                        @php
                            $due = 0;
                            if(isset($row->services->customers['balance'])){
                        ...
                        <tr>
                            ...
                            <td class="p-5 pt-0 pb-0 ">{{$row->services['dishType'] or ''}}</td>
                            <td class="p-5 pt-0 pb-0 ">{{$row->services['dishP'] or ''}}</td>
                            <td class="p-5 pt-0 pb-0 ">{{$row->services['dishCard'] or ''}}</td>
                    ...
                    <tfoot>
                        <tr>
                            <th class="p-5 pt-0 pb-0  text-right" colspan="7">Total</th>
