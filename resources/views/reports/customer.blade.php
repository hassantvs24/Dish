    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="panel panel-flat border-top-success">
                ...
                <form action="{{action('Reports\CustomerController@all_customer')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="panel-body">

                        <div class="input-group mb-15">
                            <span class="input-group-addon">Category Select</span>
                            <select class="form-control select2" name="customerCatID">
                                <option value="">ALL Customer Category</option>
